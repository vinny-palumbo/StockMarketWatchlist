...
import com.vinnypalumbo.stockmarketwatchlist.DetailActivity;
import com.vinnypalumbo.stockmarketwatchlist.MainActivity;
...
/**
 * Provider for a scrollable stocks collection widget
 */
...
public class CollectionWidgetProvider extends AppWidgetProvider {
    ...
    public void onReceive(@NonNull Context context, @NonNull Intent intent) {
        ...
        if (StockMarketWatchlistSyncAdapter.ACTION_DATA_UPDATED.equals(intent.getAction())) {
